// hacker-animation.js
(function() {
    // Remove the GitHub Pages check so it works everywhere
    document.addEventListener('DOMContentLoaded', function() {
        ...
        hackerContainer.style.zIndex = '999999'; // Increased z-index
        hackerContainer.style.overflow = 'hidden';
        document.body.appendChild(hackerContainer);

        // Make sure container is visible
        hackerContainer.style.backgroundColor = 'rgba(0,0,0,0.1)';
        ...
        console.log('Hacker animation initialized');
    });
})();
